 ...
 * new overlay. Same pattern as stripe-webhook: a missing hook is logged, not
 * thrown, because the overlay write already succeeded.
 */
export async function triggerBuildHook(reason: string): Promise<'triggered' | 'not-configured' | 'failed'> {
