...
export function Membership() {
    ...
    return (
        <div className="pt-24 pb-20">
            <section className="bg-slate-50 py-20 mb-20 relative overflow-hidden">
                ...
                >
                    {MEMBERSHIP_BENEFITS.map((benefit) => (
                        ...
                        >
                            ...
                            <ul className="mt-2 flex flex-col gap-3 border-t border-slate-200 pt-6">
                                {benefit.included.map((line) => (
                                    <li key={line} className="flex gap-3 text-sm text-slate-600 leading-relaxed">
                                        <Check
                                            className="w-4 h-4 mt-1 shrink-0 text-slate-500"
                                            strokeWidth={2}
                                            aria-hidden="true"
                                        />
                                        <span>{line}</span>
                    ...
                    <div className="max-w-3xl mx-auto text-center">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6 text-left">
                            {MEMBERSHIP_TIERS.map((tier) => (
                                <div
                                    key={tier.id}
                                    className="p-8 rounded-2xl border border-slate-200 bg-white flex flex-col gap-3"
                                >
                                    ...
                                    <p className="text-slate-600 leading-relaxed">{tier.who}</p>
                                </div>
                            ))}
                        </div>
                        ...
                        <div className="mt-12">
                            ...
                            <p className="mt-6 mx-auto max-w-xl text-slate-600 leading-relaxed">
