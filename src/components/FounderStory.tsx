...
export function FounderStory() {
    ...
    return (
        <section className="py-24 lg:py-32 bg-band">
            <Container size="md">
                <motion.div
                ...
                >
                    <div className="max-w-3xl">
                        ...
                        <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-ink mb-6">
                    ...
                    <dl className="mt-14 grid sm:grid-cols-3 gap-6 border-t border-rule pt-10">
                        {record.map((fact) => (
                            <div key={fact.title}>
                                <dt className="text-base font-bold text-ink mb-2">{fact.title}</dt>
                                <dd className="text-muted leading-relaxed">{fact.detail}</dd>
                            </div>
                        ))}
                    </dl>
                </motion.div>
