# events-hub Specification

## Purpose
Event browsing, filtering, and notification signup, backed by a live Postgres store with a scraped-and-merged Luma/Meetup fallback dataset kept current by a scheduled job.
